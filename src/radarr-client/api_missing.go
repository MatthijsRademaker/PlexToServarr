...
func (a *MissingApiService) ApiV3WantedMissingGet(ctx context.Context, localVarOptionals *MissingApiApiV3WantedMissingGetOpts) (MovieResourcePagingResource, *http.Response, error) {
	var (
