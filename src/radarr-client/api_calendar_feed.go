 ...
 * @param optional nil or *CalendarFeedApiFeedV3CalendarRadarrIcsGetOpts - Optional Parameters:
...
type CalendarFeedApiFeedV3CalendarRadarrIcsGetOpts struct {
...
func (a *CalendarFeedApiService) FeedV3CalendarRadarrIcsGet(ctx context.Context, localVarOptionals *CalendarFeedApiFeedV3CalendarRadarrIcsGetOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/feed/v3/calendar/radarr.ics"
