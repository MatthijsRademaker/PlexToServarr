...
type SonarrSettings struct {
	...
	ActiveLanguageProfileId      float64 `json:"activeLanguageProfileId,omitempty"`
	ActiveAnimeProfileId         float64 `json:"activeAnimeProfileId,omitempty"`
	ActiveAnimeLanguageProfileId float64 `json:"activeAnimeLanguageProfileId,omitempty"`
