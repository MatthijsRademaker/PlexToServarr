 ...
 * @param optional nil or *ParseApiApiV3ParseGetOpts - Optional Parameters:
     * @param "Title" (optional.String) -
     * @param "Path" (optional.String) -
@return ParseResource
*/

type ParseApiApiV3ParseGetOpts struct {
	Title optional.String
	Path  optional.String
}

func (a *ParseApiService) ApiV3ParseGet(ctx context.Context, localVarOptionals *ParseApiApiV3ParseGetOpts) (ParseResource, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v3/parse"
