 ...
 * @param optional nil or *MissingApiApiV3WantedMissingGetOpts - Optional Parameters:
...
type MissingApiApiV3WantedMissingGetOpts struct {
	Page          optional.Int32
...
func (a *MissingApiService) ApiV3WantedMissingGet(ctx context.Context, localVarOptionals *MissingApiApiV3WantedMissingGetOpts) (EpisodeResourcePagingResource, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v3/wanted/missing"
...
*/
func (a *MissingApiService) ApiV3WantedMissingIdGet(ctx context.Context, id int32) (EpisodeResource, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v3/wanted/missing/{id}"
